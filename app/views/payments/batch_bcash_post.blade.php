        ...
        <div class="body">
          <table class="table table-striped responsive-table">
            <div class='pull-right'>
              <a href="/payments" class="btn btn-primary">Voltar</a>
              <a class="btn btn-danger js_pay_lot" data-id="{{ $ids_str }}"><i class="fa fa-credit-card"></i> Pagar com Bcash</a>
            </div>
            <thead>
              <tr>
                <th>Loja</th>
